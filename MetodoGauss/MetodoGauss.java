...
public class MetodoGauss{
	...
	protected static boolean estaNoVetor(double[] vetorDivisao, double[] vetorDivisao2)
	{
		for(int i=0; i<m.getLinhas(); i++)
	...
	protected static double[] passarProVetor(double[] aux, int linha, double valorARemover){
		try{
	...
	protected static void subtrair(double[] subtrair, int linha){
		try{
			for(int i=0; i<m.getLinhas()+1; i++){
